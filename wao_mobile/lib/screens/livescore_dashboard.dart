...
class _LiveScoresHomeState extends State<LiveScoresHome> {
  ...
  Color MatchConatier = lightColorScheme.primary;
  int _counter = 0;     
  ...
  void _toggleTheme() {
    setState(() {
      ...
      if (_counter%2 == 0) {
        ...
        MatchConatier = lightColorScheme.primary;
        ...
        MatchConatier = darkColorScheme.primary;
  ...
  Widget build(BuildContext context) {
    ...
    AppBar appBar = AppBar(
      ...
      title: const Center(
          child: Text("Live Score", style: TextStyle(color: Colors.white))
      ),
      actions: [
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            Text(
              'Live Scores', 
              style: TextStyle(
                fontSize: 20, fontWeight: FontWeight.bold, color: WlcContainer,
              ),
            ),
