...
class AboutPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const AboutHome(title: 'Main About'),
    );
  }
}

class AboutHome extends StatefulWidget {
  const AboutHome({super.key, required this.title});
...
class AboutTile extends StatelessWidget {
  const AboutTile({super.key, required this.tileLabel, required this.tileContent, required this.fgcolor});
