                ...
                return ChatListTile(
                  ...
                  onTap: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (context) => ChatScreen(chatThreadId: chatThread.id),
                      ),
                    );
                  },
                );
...
class _NewChatDialogState extends State<NewChatDialog> {
  ...
  void _createChat(BuildContext context, ChatService chatService) {
    ...
    if (!_isGroup && _selectedUserIds.length == 1) {
      ...
      if (existingChatId != null) {
        ...
        Navigator.push(
          context,
          MaterialPageRoute(
            builder: (context) => ChatScreen(chatThreadId: existingChatId),
          ),
        );
        return;
      }
    ...
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (context) => ChatScreen(chatThreadId: chatId!),
      ),
    );
  }
}
