        ...
        <div className="flex flex-col md:flex-row gap-4 mb-6">
          ...
          <div className="relative">
            <select
              ...
              className="pl-4 pr-8 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-slate focus:border-transparent cursor-pointer appearance-none bg-white min-w-[120px]"
            >
