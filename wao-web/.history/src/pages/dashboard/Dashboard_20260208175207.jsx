    ...
    <section className="scrollbar-hide pb-8">
      ...
      <div className="flex flex-col md:flex-row py-4 md:py-6 justify-between items-center">
        ...
        <div className="flex gap-3">
          ...
          {/* Create Game Button */}
          <button className="flex items-center gap-2 px-6 py-3 bg-gradient-to-br from-[#D30336] to-[#a8022b] text-white font-semibold rounded-lg hover:shadow-lg hover:scale-105 transition-all duration-200">
