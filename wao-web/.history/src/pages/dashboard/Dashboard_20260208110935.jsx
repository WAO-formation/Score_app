...
function Dashboard() {
  ...
  return (
    <section className='flex flex-col lg:flex-row gap-4 md:gap-6 h-full'>
      {/* Main Content - 70% */}
      <div className='flex-1 lg:w-[70%] overflow-y-auto space-y-6 pr-0 lg:pr-2 scrollbar-hide'>
        {/* Welcome Section */}
      ...
      {/* Sidebar - 30% */}
      <aside className='w-full lg:w-[30%] overflow-y-auto space-y-6 pl-0 lg:pl-2 scrollbar-hide'>
        {/* Calendar Widget */}
        <div className="bg-white rounded-lg shadow-sm p-6">
          <div className="flex items-center justify-between mb-4">
