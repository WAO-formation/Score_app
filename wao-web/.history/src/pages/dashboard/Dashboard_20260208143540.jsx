...
function Dashboard() {
  return (
    <section className="flex flex-col mb-6 lg:flex-row gap-4 h-full overflow-y-auto scrollbar-hide">
      {/* this will cover the main container */}
      <div className="flex-1 lg:w-[75%] space-y-6 pr-0 pb-6">
      ...
      <aside className="w-full lg:w-[25%] space-y-6 pl-0 lg:pl-2 pb-6">
