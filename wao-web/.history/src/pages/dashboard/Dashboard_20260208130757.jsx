...
function Dashboard() {
  ...
  <div className="relative z-10 space-y-4">
    ...
    {/* Full width button */}
    <button className="w-full py-2 bg-[#D30336] text-white border-2 border-gray-300 text-gray-600 rounded-lg font-medium transition-colors flex items-center justify-center gap-2">
      Add Team
    </button>
  </div>
</div>
