  ...
  return (
    <section className="flex flex-col lg:flex-row gap-4 h-full">
      ...
      <div className="flex-1 lg:w-[75%] overflow-y-auto spacer-y-6 pr-0 scrollbar-hide ">
        ...
        <h2 className="text-xl lg:2xl font-bold text-[#011B3B] mb-4 md:mt-6 mt-4">
          Overview
        </h2>
        ...
        <div className="bg-white rounded-lg shadow-sm p-6 mt-4">
          ...
          <div className="space-y-4">
            {[1, 2, 3, 4, 5].map((item) => (
              <div
                key={item}
                className="flex items-center justify-between py-3 border-b bordergray-100 last:border-b-0"
              >
