    ...
    <section className="flex flex-col lg:flex-row gap-4 h-full">
      ...
      <div className="flex-1 lg:w-[75%] overflow-y-auto spacer-y-6 pr-0 scrollbar-hide ">
        ...
        <div className="grid grid-col-1 md:grid-cols-3 gap-4">
          <div className="shadow-sm py-4 px-4 bg-yellow-400 rounded-xl relative overflow-hidden">
            {/* Ball image positioned at bottom left */}
            <div className="absolute -right-15 -bottom-18 opacity-20">
              <img
                src="/assets/design/wao-ball.png"
                alt="ball gradient"
                className="w-44 h-50 object-contain"
              />
            </div>
