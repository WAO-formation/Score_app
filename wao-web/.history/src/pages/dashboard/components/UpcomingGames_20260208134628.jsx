          ...
          <div className="flex gap-4 pb-2">
            {games.length > 0 ? (
              ...
              games.map((game) => (
                <div
                  key={game.id}
                  className="min-w-[320px] bg-[#FEFEFA] rounded-xl p-4 relative overflow-hidden flex-shrink-0 shadow-sm"
                >
                  {/* Teams Section */}
                  <div className="flex items-center justify-between mb-4 relative z-10">
                    ...
                    {/* Team 2 */}
                    <div className="flex flex-col items-center flex-1">
                      <div className="w-14 h-14 bg-[#A50229] rounded-full flex items-center justify-center mb-2 relative">
                        {/* Ball image positioned at bottom right */}
                        <div className="absolute -right-18 -bottom-18 opacity-15">
                          <img
