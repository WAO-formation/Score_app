...
const UpcomingGames = ({ games = [] }) => {
  return (
    <div className="bg-white rounded-xl shadow-sm py-5 px-5">
      ...
      {/* Scrollable Container - Fixed for all screen sizes */}
                ...
                <div className="flex items-center justify-between mb-4 relative z-10">
                  ...
                  <div className="flex flex-col items-center flex-1">
                    <div className="w-14 h-14 bg-yellow-400 rounded-full flex items-center justify-center mb-2 relative shadow-md overflow-visible">
                      ...
                      <div className="absolute -left-1.5 -top-2 w-8 h-8 opacity-40 pointer-events-none">
                        <img
                          src="/assets/design/wao-ball.png"
                          alt="ball"
                          className="w-full h-full object-contain brightness-0 opacity-60"
                        />
                      </div>
                  ...
                  <div className="flex flex-col items-center flex-1">
                    <div className="w-14 h-14 bg-[#A50229] rounded-full flex items-center justify-center mb-2 relative shadow-md overflow-visible">
                      {/* Small ball image cutting into the team icon */}
                      <div className="absolute -right-1.5 -bottom-2 w-8 h-8 opacity-40 pointer-events-none">
                        <img
                          src="/assets/design/wao-ball.png"
                          alt="ball"
