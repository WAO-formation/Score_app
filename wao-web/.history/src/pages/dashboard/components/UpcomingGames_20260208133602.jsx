        ...
        <div className="flex gap-4 pb-2">
          {games.length > 0 ? (
            ...
            games.map((game) => (
              <div
                key={game.id}
                className="min-w-[280px] bg-gray-50 rounded-xl p-4 relative overflow-hidden flex-shrink-0 shadow-sm"
              >
                ...
                <div className="flex items-center justify-between mb-4 relative z-10">
                  ...
                  <div className="flex flex-col items-center flex-1">
                    <div className="w-14 h-14 bg-yellow-500 rounded-full flex items-center justify-center mb-2 border-2 border-gray-600">
                      <span className="text-white font-bold text-sm">
                        {game.team1.substring(0, 2).toUpperCase()}
                      </span>
                    </div>
                    <p className="text-gray-500 text-sm font-semibold text-center line-clamp-1">
                      {game.team1}
                    </p>
                  </div>
