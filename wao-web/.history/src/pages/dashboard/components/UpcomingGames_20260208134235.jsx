        ...
        <div className="flex gap-4 pb-2">
          {games.length > 0 ? (
            ...
            games.map((game) => (
              <div
                key={game.id}
                className="min-w-[320px] bg-gray-50 rounded-xl p-4 relative overflow-hidden flex-shrink-0 shadow-sm"
              >
                ...
                <div className="flex items-center justify-between mb-4 relative z-10">
                  ...
                  {/* Team 2 */}
                  <div className="flex flex-col items-center flex-1">
                    <div className="w-14 h-14 bg-[#A50229] rounded-full flex items-center justify-center mb-2">
                      <span className="text-white font-bold text-sm">
