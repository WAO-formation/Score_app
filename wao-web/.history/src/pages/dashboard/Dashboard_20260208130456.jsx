...
function Dashboard() {
  ...
  <div className="relative z-10 space-y-4">
    ...
    <div className="flex items-center justify-between">
      <h3 className="font-semibold text-[#011B3B]">Teams</h3>
      <span className="text-sm text-gray-500">9 active</span>
    </div>
    ...
    <div className="flex items-center justify-between">
      <div className="flex -space-x-2">
        ...
        <div className="w-10 h-10 rounded-full bg-gray-100 border-2 border-white flex items-center justify-center shadow-sm">
          <span className="text-[#011B3B] font-semibold text-xs">+5</span>
        </div>
      </div>
    </div>

    {/* Full width button */}
    <button className="w-full py-2.5 border-2 border-dashed border-gray-300 text-gray-600 rounded-lg font-medium hover:border-[#D30336] hover:text-[#D30336] transition-colors flex items-center justify-center gap-2">
