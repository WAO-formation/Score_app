  ...
  return (
    <section className="flex flex-col lg:flex-row gap-4 h-full">
      ...
      <div className="flex-1 lg:w-[75%] overflow-y-auto spacer-y-6 pr-0 scrollbar-hide ">
        ...
        <div className="grid grid-col-1 md:grid-cols gap-4">
            <div className="shadow-sm p-2 px-4 bg-yellow-400 rounded-xl">
               <div className="flex gap-2 items-center">
                ...
                <h4 className="font-bold text-white text-sm">Upcoming Games</h4>
               </div>
            </div>
        </div>
      </div>
