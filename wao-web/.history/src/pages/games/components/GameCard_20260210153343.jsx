...
const GameCard = ({ game, onStartGame }) => {
  ...
  return (
    <div className="bg-gradient-to-br from-gray-50 to-white rounded-xl p-4 border border-gray-200 hover:shadow-lg transition-all relative overflow-hidden">
      {/* Background Ball */}
      <div className="absolute -right-12 -bottom-12 opacity-35 pointer-events-none">
        <img
      ...
      <div className="flex items-center justify-between mb-4 relative z-10 mt-6">
        ...
        <div className="flex flex-col items-center flex-1">
          <div className="w-14 h-14 bg-gradient-to-br from-[#FFC600] to-[#FF6B35] rounded-full flex items-center justify-center mb-2 shadow-md">
          ...
          {game.status === 'completed' && (
            <p className="text-2xl font-bold text-[#011B3B] mt-1">{game.homeScore}</p>
          )}
        </div>
        ...
        <div className="flex flex-col items-center mx-3">
          ...
          {game.status === 'live' && (
            <div className="mt-2 text-center">
              <p className="text-green-600 text-xs font-bold">{game.currentQuarter}</p>
        ...
        {/* Away Team */}
        <div className="flex flex-col items-center flex-1">
          <div className="w-14 h-14 bg-gradient-to-br from-[#D30336] to-[#a8022b] rounded-full flex items-center justify-center mb-2 shadow-md">
            <span className="text-white font-bold text-sm">
          ...
          {game.status === 'completed' && (
            <p className="text-2xl font-bold text-[#011B3B] mt-1">{game.awayScore}</p>
          )}
        </div>
      </div>
