...
const GameSimulation = () => {
  ...
  const addScore = (team, category, points) => {
    setGame((prev) => {
      ...
      newGame.quarters[quarterKey][team] =
        Object.values(newGame.scoring).reduce(
          (total, cat) => total + cat[team],
          0,
        ) -
        ...
        <div className="p-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="bg-gradient-to-br from-yellow-50 to-orange-50 rounded-xl p-6 border-2 border-yellow-200">
              <div className="flex items-center gap-3 mb-6">
                ...
                <div>
                  <h4 className="text-lg font-bold text-[#011B3B]">
                    {game?.homeTeam}
                  </h4>
                  <p className="text-sm text-gray-600">
                    Current: {game?.scoring[activeScoreTab]?.home || 0} pts
                  </p>
                </div>
              </div>
            ...
            <div className="bg-gradient-to-br from-red-50 to-pink-50 rounded-xl p-6 border-2 border-red-200">
              <div className="flex items-center gap-3 mb-6">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">
                    Current: {game?.scoring[activeScoreTab]?.away || 0} pts
                  </p>
                </div>
              </div>
          ...
          <div className="mt-6 bg-blue-50 border border-blue-200 rounded-lg p-4">
            <p className="text-sm text-blue-800">
              {activeScoreTab === "kingdom" &&
                "👑 Kingdom: Points scored by invading opponent's Kingdom and bouncing the ball (1 point per second-interval bounce)"}
              {activeScoreTab === "workout" &&
                "💪 Workout: Points accrued for time spent in your own Workout area while displaying skills"}
              {activeScoreTab === "goalSetting" &&
                "🎯 Goal Setting: Standard goals (1 point) and specialized scores from Oval-Crown/Goalposts"}
              {activeScoreTab === "judges" &&
                "⚖️ Judges: Additional points awarded by judges (10% of total score)"}
            </p>
          </div>
        </div>
      </div>
          ...
          <div className="grid grid-cols-3 gap-6 items-center mt-8">
            ...
            <div className="text-center">
              <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-white/20">
                <div className="text-[#FFC600] text-xl font-bold mb-2">
                  QUARTER {currentQuarter}
                </div>
                <div
                ...
                <div className="flex gap-3 justify-center">
                  ...
                  <button
                    onClick={() =>
                      setTimeRemaining(currentQuarter <= 2 ? 17 * 60 : 13 * 60)
                    }
                    className="bg-white/20 hover:bg-white/30 p-4 rounded-xl transition-all"
                ...
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex gap-8">
                    <span className="font-bold text-yellow-600">
                      {game.quarters[`q${q}`]?.home || 0}
                    </span>
                    <span className="font-bold text-red-600">
                      {game.quarters[`q${q}`]?.away || 0}
                    </span>
                  </div>
                </div>
              </div>
        ...
        <div className="bg-white rounded-2xl shadow-lg p-6">
          ...
          <div className="space-y-4">
            {[
              ...
              <div
                key={cat.key}
                className={`bg-${cat.color}-50 p-4 rounded-xl`}
              >
                ...
                <div className="flex justify-between items-center">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="font-bold text-lg">
                      {game.scoring[cat.key]?.home || 0}
                    </span>
                  </div>
                  <div className="flex items-center gap-2">
                    <span className="font-bold text-lg">
                      {game.scoring[cat.key]?.away || 0}
                    </span>
