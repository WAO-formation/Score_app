          ...
          <div className="flex flex-col md:flex-row items-center justify-center gap-6 mb-6">
            ...
            <div className="flex flex-col items-center">
              <div className="w-24 h-24 bg-yellow-400 rounded-full flex items-center justify-center mb-2 relative shadow-md overflow-hidden">
                ...
                <div className="absolute -left-15 -top-15 w-30 h-40 opacity-40 pointer-events-none">
                  <img
                    src="/assets/design/wao-ball.png"
                    alt="ball"
            ...
            {/* Away Team */}
            <div className="flex flex-col items-center">
              <div className="w-14 h-14 bg-gradient-to-br from-[#D30336] to-[#a8022b] rounded-full flex items-center justify-center mb-2 relative shadow-md overflow-hidden">
                {/* Small ball image cutting into the team icon */}
                ...
                <span className="text-white font-bold text-3 relative z-10">
