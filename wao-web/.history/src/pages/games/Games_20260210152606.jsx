  ...
  return (
    <section className="scrollbar-hide p-2 pb-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
         <StatCard type="upcoming" count={upcomingGames.length} subtitle="This Week's Games" />
            <StatCard type="live" count={liveGames.length} subtitle="Active Right Now" />
            <StatCard type="completed" count={completedGames.length} subtitle="This Month" />
        <div className="bg-white rounded-lg shadow-sm p-6">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-gray-600 text-sm">Upcoming Games</p>
              <p className="text-3xl font-bold text-[#011B3B] mt-1">{upcomingGames.length}</p>
            </div>
        ...
        <div className="bg-white rounded-lg shadow-sm p-6">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-gray-600 text-sm">Live Games</p>
              <p className="text-3xl font-bold text-green-600 mt-1">{liveGames.length}</p>
            </div>
        ...
        <div className="bg-white rounded-lg shadow-sm p-6">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-gray-600 text-sm">Completed Games</p>
              <p className="text-3xl font-bold text-[#D30336] mt-1">{completedGames.length}</p>
            </div>
            <div className="w-12 h-12 bg-red-100 rounded-full flex items-center justify-center">
              <Trophy className="w-6 h-6 text-[#D30336]" />
            </div>
          </div>
        </div>
      </div>
