  ...
  return (
    <section className="scrollbar-hide p-2 pb-8">
      ...
      <div className="bg-gradient-to-br from-[#011B3B] to-[#022d5f] rounded-lg shadow-lg p-6 mb-6 relative overflow-hidden">
        {/* Background Ball */}
        <div className="absolute -right-20 -top-30 opacity-10">
          <img
        ...
        <div className="relative z-10">
          ...
          <div className="flex flex-col md:flex-row items-center justify-center gap-6 mb-6">
            ...
            <div className="flex flex-col items-center">
              <div className="w-24 h-24 bg-gradient-to-br from-[#FFC600] to-[#FF6B35] rounded-full flex items-center justify-center shadow-lg mb-3">
