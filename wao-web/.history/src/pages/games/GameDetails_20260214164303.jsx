...
const GameDetails = () => {
  ...
  if (!game) {
    return (
      <div className="p-8 text-center">
        <h2 className="text-2xl font-bold text-[#011B3B] mb-4">
          Game not found
        </h2>
        <button
  ...
  const awayTeamStats = {
    ...
    lastFiveGames: [
      ...
      {
        opponent: "Steel Panthers",
        result: "W",
        score: "43-38",
        date: "Jan 29",
      },
      {
        opponent: "Mighty Sharks",
        result: "D",
        score: "42-42",
        date: "Jan 24",
      },
      {
        opponent: "Blazing Comets",
        result: "W",
        score: "48-40",
        date: "Jan 20",
      },
          ...
          <div className="flex flex-col md:flex-row items-center justify-center gap-6 mb-6">
            ...
            <div className="flex flex-col items-center">
              <div className="w-24 h-24 bg-yellow-400 rounded-full flex items-center justify-center mb-2 relative shadow-md overflow-hidden">
                ...
                <div className="absolute -left-20 -top-20 w-40 h-40 opacity-40 pointer-events-none">
                  <img
                    src="/assets/design/wao-ball.png"
                    alt="ball"
                ...
                <span className="text-white font-bold text-3xl font-bold relative z-10">
            ...
            {/* Away Team */}
            <div className="flex flex-col items-center">
              <div className="w-24 h-24 bg-gradient-to-br from-[#D30336] to-[#a8022b] rounded-full flex items-center justify-center mb-2 relative shadow-md overflow-hidden">
                {/* Small ball image cutting into the team icon */}
                <div className="absolute -right-20 -bottom-20 w-40 h-40 opacity-40 pointer-events-none">
                  <img
                    src="/assets/design/wao-ball.png"
                    alt="ball"
                    className="w-full h-full object-contain brightness-0 invert opacity-80"
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className="bg-white rounded-lg shadow-sm p-6">
            <div className="flex items-center gap-3 mb-6">
              ...
              <div>
                <h3 className="text-lg font-bold text-[#011B3B]">
                  {homeTeamStats.name}
                </h3>
            ...
            <div className="grid grid-cols-2 gap-4 mt-4">
              <div className="text-center">
                <p className="text-xl font-bold text-[#011B3B]">
                  {homeTeamStats.stats.goalsFor}
                </p>
                <p className="text-xs text-gray-600">Goals For</p>
              </div>
              <div className="text-center">
                <p className="text-xl font-bold text-[#011B3B]">
                  {homeTeamStats.stats.goalsAgainst}
                </p>
          ...
          <div className="bg-white rounded-lg shadow-sm p-6">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="bg-green-50 rounded-lg p-3 text-center">
                <p className="text-2xl font-bold text-green-600">
                  {awayTeamStats.stats.wins}
                </p>
                <p className="text-xs text-gray-600">Wins</p>
              </div>
              <div className="bg-red-50 rounded-lg p-3 text-center">
                <p className="text-2xl font-bold text-red-600">
                  {awayTeamStats.stats.losses}
                </p>
                <p className="text-xs text-gray-600">Losses</p>
              </div>
              <div className="bg-yellow-50 rounded-lg p-3 text-center">
                <p className="text-2xl font-bold text-yellow-600">
                  {awayTeamStats.stats.draws}
                </p>
                <p className="text-xs text-gray-600">Draws</p>
              </div>
              <div className="bg-blue-50 rounded-lg p-3 text-center">
                <p className="text-2xl font-bold text-blue-600">
                  {awayTeamStats.stats.avgScore}
                </p>
                <p className="text-xs text-gray-600">Avg Score</p>
              </div>
            </div>
            ...
            <div className="grid grid-cols-2 gap-4 mt-4">
              <div className="text-center">
                <p className="text-xl font-bold text-[#011B3B]">
                  {awayTeamStats.stats.goalsFor}
                </p>
                <p className="text-xs text-gray-600">Goals For</p>
              </div>
              <div className="text-center">
                <p className="text-xl font-bold text-[#011B3B]">
                  {awayTeamStats.stats.goalsAgainst}
                </p>
                <p className="text-xs text-gray-600">Goals Against</p>
              </div>
            </div>
            ...
            <div className="space-y-4">
              ...
              <div>
                <div className="flex justify-between items-center mb-2">
                  ...
                  <span className="text-sm font-bold text-[#011B3B]">
                    {homeTeamStats.scoringBreakdown.kingdom}%
                  </span>
                </div>
                <div className="w-full bg-gray-200 rounded-full h-3">
                  <div
                    ...
                    style={{
                      width: `${homeTeamStats.scoringBreakdown.kingdom}%`,
                    }}
                  ></div>
                </div>
              </div>
              ...
              <div>
                <div className="flex justify-between items-center mb-2">
                  ...
                  <span className="text-sm font-bold text-[#011B3B]">
                    {homeTeamStats.scoringBreakdown.workout}%
                  </span>
                </div>
                <div className="w-full bg-gray-200 rounded-full h-3">
                  <div
                    ...
                    style={{
                      width: `${homeTeamStats.scoringBreakdown.workout}%`,
                    }}
                  ></div>
                </div>
              </div>
              ...
              <div>
                <div className="flex justify-between items-center mb-2">
                  ...
                  <span className="text-sm font-bold text-[#011B3B]">
                    {homeTeamStats.scoringBreakdown.goalSetting}%
                  </span>
                </div>
                <div className="w-full bg-gray-200 rounded-full h-3">
                  <div
                    ...
                    style={{
                      width: `${homeTeamStats.scoringBreakdown.goalSetting}%`,
                    }}
                  ></div>
                </div>
              </div>
              ...
              <div>
                <div className="flex justify-between items-center mb-2">
                  ...
                  <span className="text-sm font-bold text-[#011B3B]">
                    {homeTeamStats.scoringBreakdown.judges}%
                  </span>
                </div>
                <div className="w-full bg-gray-200 rounded-full h-3">
                  <div
                    ...
                    style={{
                      width: `${homeTeamStats.scoringBreakdown.judges}%`,
                    }}
                  ></div>
                </div>
              </div>
            ...
            <div className="space-y-4">
              ...
              <div>
                <div className="flex justify-between items-center mb-2">
                  ...
                  <span className="text-sm font-bold text-[#011B3B]">
                    {awayTeamStats.scoringBreakdown.kingdom}%
                  </span>
                </div>
                <div className="w-full bg-gray-200 rounded-full h-3">
                  <div
                    className="bg-gradient-to-r from-purple-500 to-purple-600 h-3 rounded-full transition-all duration-500"
                    style={{
                      width: `${awayTeamStats.scoringBreakdown.kingdom}%`,
                    }}
                  ></div>
                </div>
              </div>
              ...
              <div>
                <div className="flex justify-between items-center mb-2">
                  ...
                  <span className="text-sm font-bold text-[#011B3B]">
                    {awayTeamStats.scoringBreakdown.workout}%
                  </span>
                </div>
                <div className="w-full bg-gray-200 rounded-full h-3">
                  <div
                    className="bg-gradient-to-r from-blue-500 to-blue-600 h-3 rounded-full transition-all duration-500"
                    style={{
                      width: `${awayTeamStats.scoringBreakdown.workout}%`,
                    }}
                  ></div>
                </div>
              </div>
              ...
              <div>
                <div className="flex justify-between items-center mb-2">
                  ...
                  <span className="text-sm font-bold text-[#011B3B]">
                    {awayTeamStats.scoringBreakdown.goalSetting}%
                  </span>
                </div>
                <div className="w-full bg-gray-200 rounded-full h-3">
                  <div
                    className="bg-gradient-to-r from-green-500 to-green-600 h-3 rounded-full transition-all duration-500"
                    style={{
                      width: `${awayTeamStats.scoringBreakdown.goalSetting}%`,
                    }}
                  ></div>
                </div>
              </div>
              ...
              <div>
                <div className="flex justify-between items-center mb-2">
                  ...
                  <span className="text-sm font-bold text-[#011B3B]">
                    {awayTeamStats.scoringBreakdown.judges}%
                  </span>
                </div>
                <div className="w-full bg-gray-200 rounded-full h-3">
                  <div
                    className="bg-gradient-to-r from-orange-500 to-orange-600 h-3 rounded-full transition-all duration-500"
                    style={{
                      width: `${awayTeamStats.scoringBreakdown.judges}%`,
                    }}
                  ></div>
                </div>
              </div>
            ...
            <div className="space-y-3">
              {homeTeamStats.lastFiveGames.map((game, index) => (
                ...
                >
                  <div className="flex items-center gap-3">
                    <div
                      className={`w-8 h-8 rounded-full flex items-center justify-center font-bold text-white ${getFormColor(game.result)}`}
                    >
                      {game.result}
                    </div>
                    <div>
                      <p className="font-semibold text-[#011B3B] text-sm">
                        vs {game.opponent}
                      </p>
      ...
      {activeTab === "game-details" &&
        (game.status === "live" || game.status === "completed") && (
          <div className="space-y-6">
            ...
            <div className="bg-white rounded-lg shadow-sm p-6">
              <h3 className="text-lg font-bold text-[#011B3B] mb-6">
                Quarter by Quarter
              </h3>
                ...
                <table className="w-full">
                  <thead>
                    <tr className="border-b border-gray-200">
                      ...
                      <th className="text-center py-3 px-4 text-sm font-semibold text-gray-700 bg-gray-50">
                        Total
                      </th>
                    </tr>
                  </thead>
                  <tbody>
                    <tr className="border-b border-gray-100">
                      <td className="py-4 px-4">
                        <div className="flex items-center gap-2">
                          <div className="w-10 h-10 bg-yellow-400 rounded-full flex items-center justify-center mb-2 relative shadow-md overflow-visible">
                            {/* Small ball image cutting into the team icon */}
                            <div className="absolute -left-15 -top-18 w-20 h-30 opacity-40 pointer-events-none">
                              <img
                                src="/assets/design/wao-ball.png"
                                alt="ball"
                                className="w-full h-full object-contain brightness-0 invert opacity-80"
                      ...
                      <td className="text-center py-4 px-4 font-bold text-[#011B3B]">
                        {game.quarters.q1.home}
                      </td>
                      <td className="text-center py-4 px-4 font-bold text-[#011B3B]">
                        {game.quarters.q2.home}
                      </td>
                      <td className="text-center py-4 px-4 font-bold text-[#011B3B]">
                        {game.quarters.q3.home}
                      </td>
                      <td className="text-center py-4 px-4 font-bold text-[#011B3B]">
                        {game.quarters.q4.home}
                      </td>
                      <td className="text-center py-4 px-4 font-bold text-[#011B3B] text-xl bg-gray-50">
                        {game.homeScore}
                      </td>
                    </tr>
                    <tr>
                      <td className="py-4 px-4">
                        <div className="flex items-center gap-2">
                          <div className="w-10 h-10 bg-[#A50229] rounded-full flex items-center justify-center mb-2 relative shadow-md overflow-visible">
                            {/* Small ball image cutting into the team icon */}
                            <div className="absolute -right-5 -bottom-8 w-15 h-15 opacity-40 pointer-events-none">
                              <img
                                src="/assets/design/wao-ball.png"
                                alt="ball"
                                className="w-full h-full object-contain brightness-0 invert opacity-80"
                      ...
                      <td className="text-center py-4 px-4 font-bold text-[#011B3B]">
                        {game.quarters.q1.away}
                      </td>
                      <td className="text-center py-4 px-4 font-bold text-[#011B3B]">
                        {game.quarters.q2.away}
                      </td>
                      <td className="text-center py-4 px-4 font-bold text-[#011B3B]">
                        {game.quarters.q3.away}
                      </td>
                      <td className="text-center py-4 px-4 font-bold text-[#011B3B]">
                        {game.quarters.q4.away}
                      </td>
                      <td className="text-center py-4 px-4 font-bold text-[#011B3B] text-xl bg-gray-50">
                        {game.awayScore}
                      </td>
