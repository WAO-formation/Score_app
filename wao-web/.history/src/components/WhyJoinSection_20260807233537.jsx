  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 mt-14 flex flex-wrap items-center justify-center gap-4">
        <Link
          to="/login"
          className="wj-cta inline-flex items-center justify-center rounded-full px-8 py-4 text-sm font-semibold uppercase tracking-widest text-white transition"
        ...
        <a
          href="#games"
          className="wj-cta inline-flex items-center justify-center rounded-full border border-white/20 bg-white/5 px-8 py-4 text-sm font-semibold uppercase tracking-widest text-white backdrop-blur-sm transition hover:bg-white/10"
