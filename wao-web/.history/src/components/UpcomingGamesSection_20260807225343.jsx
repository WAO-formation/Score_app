...
const GameCard = ({ game, index }) => {
  ...
  return (
    <div
      className={`game-card flex-shrink-0 w-72 sm:w-80 flex flex-col rounded-2xl border border-gray-300/70 bg-white overflow-hidden hover:shadow-xl transition-all duration-300 hover:-translate-y-1`}
    >
      {/* Date + time */}
