...
const CompactCalendar = () => {
  ...
  return (
    <div className="space-y-2 bg-gray-50 rounded-lg px-4 py-4 relative overflow-hidden">
      {/* Ball image positioned at bottom left with yellow/gradient overlay */}
      <div className="absolute -left-18 -bottom-18 opacity-20">
        <div className="relative w-50 h-50">
          ...
          <div className="absolute inset-0 bg-gradient-to-br from-yellow-400 via-orange-400 to-red-500 mix-blend-multiply"></div>
        </div>
      </div>
