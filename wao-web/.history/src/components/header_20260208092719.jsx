...
const Header = ({ onMenuClick }) => {
  return (
    <header className="h-16 bg-white shadow-sm flex items-center justify-between px-4 md:px-6">
      ...
      <button 
        onClick={onMenuClick}
        className="lg:hidden p-2 text-[#011B3B] hover:bg-gray-100 rounded-lg transition-colors"
      >
      ...
      <div className="flex items-center space-x-2 lg:hidden">
        ...
        <span className="text-[#011B3B] font-semibold text-xl">WAO</span>
      </div>
      ...
      <div className="hidden md:flex flex-1 max-w-md mx-4 lg:mx-8">
        <div className="relative w-full">
          ...
          <input
            type="text"
            placeholder="Search..."
            className="w-full pl-10 pr-4 py-2 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#D30336] focus:border-transparent"
          />
        </div>
      </div>
      ...
      <div className="flex items-center space-x-2 md:space-x-4">
        ...
        <div className="flex items-center space-x-2 md:space-x-3 pl-2 md:pl-4 border-l border-gray-200">
          <div className="w-8 h-8 md:w-9 md:h-9 bg-[#FFC600] rounded-full flex items-center justify-center">
            <span className="text-[#011B3B] font-semibold text-xs md:text-sm">JD</span>
          </div>
          {/* User Name - Hidden on mobile */}
          <div className="hidden lg:block">
            <p className="text-sm font-medium text-[#011B3B]">John Doe</p>
