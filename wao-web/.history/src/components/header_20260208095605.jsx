...
const Header = ({ onMenuClick }) => {
  return (
    <header className="h-18 bg-white shadow-sm flex items-center justify-between px-4 md:px-6">
     ...
     <div className="flex items-center gap-2 ">
      ...
      >
        ...
        <h2 className="text-xl lg:text-2xl font-bold text-[#011B3B]">Dashboard</h2>
     </div>
      ...
      <div className="hidden md:flex flex-1 max-w-md mx-4">
        ...
        <div className="flex items-center space-x-2 md:space-x-3 pl-2 md:pl-4 border-l border-gray-200">
          <div className="w-8 h-8 md:w-9 md:h-9 bg-[#FFC600] rounded-full flex items-center justify-center">
            <span className="text-[#011B3B] font-bold  text-xs md:text-sm">
              JD
            </span>
          </div>
