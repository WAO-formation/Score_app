...
const CompactCalendar = () => {
  ...
  return (
    <div className="space-y-2 bg-gray-50 rounded-lg px-4 py-4 relative overflow-hidden">
      {/* Gradient Ball - Signature Design */}
      <div className="absolute -right-12 -bottom-12 w-32 h-32 rounded-full bg-gradient-to-br from-[#FFC600] via-[#FF6B35] to-[#D30336] opacity-10 blur-2xl"></div>
      
      {/* Alternative: Multiple gradient balls for depth */}
      <div className="absolute -right-8 -bottom-8 w-24 h-24 rounded-full bg-gradient-to-br from-[#011B3B] to-[#D30336] opacity-15 blur-xl"></div>
      ...
      {/* Calendar Grid */}
      <div className="grid grid-cols-7 gap-1 text-center text-xs mt-4 relative z-10">
        {/* Day Headers */}
