  ...
  return (
    ...
    >
      ...
      <div className="px-5 pb-5 mt-auto space-y-3">
        ...
        <Link
          to="/games"
          className="flex items-center justify-center w-full py-3 rounded-xl text-xs font-semibold uppercase tracking-widest text-white transition hover:opacity-90"
          style={{ backgroundColor: BRAND.prdarkimary, fontFamily: BRAND.font.body }}
        >
          View Details
        </Link>
      </div>
