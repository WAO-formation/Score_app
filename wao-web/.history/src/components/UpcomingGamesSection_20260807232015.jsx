...
const GameCard = ({ game }) => {
  return (
    <div
      className="game-card flex-shrink-0 w-72 sm:w-80 flex flex-col rounded-2xl border border-gray-200 bg-white overflow-hidden hover:shadow-lg transition-all duration-300 hover:-translate-y-1"
    >
      {/* Date + time */}
      ...
      <div className="flex items-center justify-between gap-3 px-5 py-5">
        ...
        {/* Away */}
        <div className="flex flex-col items-center gap-2 flex-1">
          <div className="w-14 h-14 rounded-2xl bg-amber-400 flex items-center justify-center" style={{ borderColor: BRAND.dark }}>
      ...
      <div className="px-5 pb-5 mt-auto space-y-3">
        ...
        <Link
          to="/games"
          className="flex items-center justify-center w-full py-3 rounded-sm text-xs font-semibold uppercase tracking-widest text-white transition hover:opacity-90"
