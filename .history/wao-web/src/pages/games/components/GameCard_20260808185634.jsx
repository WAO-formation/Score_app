      ...
      <div className="p-4">
        ...
        <div className="flex items-center justify-between gap-2">
          ...
          <div className="flex flex-col items-center flex-1">
            ...
            {(isLive || isCompleted) && (
              <p className={`text-2xl font-bold mt-1 text-[#011B3B]"}`} style={{ fontFamily: H }}>{game.homeScore}</p>
            )}
          </div>
          ...
          <div className="flex flex-col items-center">
            {isLive ? (
              <div className="flex flex-col items-center">
                <div className="flex items-center gap-2 bg-zinc-600/10 px-3 py-1.5">
                  <span className="text-xl font-bold text-[#011B3B]" style={{ fontFamily: H }}>{game.homeScore}</span>
                  <span className="text-zinc-950/80">:</span>
                  <span className="text-xl font-bold text-[#011B3B]" style={{ fontFamily: H }}>{game.awayScore}</span>
                </div>
