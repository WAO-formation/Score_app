    ...
    <div className="relative z-10 flex h-full w-full items-center px-6 sm:px-10 lg:px-16">
      <div className="mx-auto w-full max-w-7xl flex justify-end">
        <div className="max-w-xl text-right">
          ...
          <h1
            className="uppercase  tracking-wide text-white text-4xl sm:text-5xl md:text-6xl drop-shadow-[0_2px_8px_rgba(0,0,0,0.8)]"
            style={{ fontFamily: "'Anton', sans-serif" }}
          >
            A New Era of Competition<br />Without Boundaries
          </h1>

          <p
            className="mt-5 text-sm md:text-base text-white/75 leading-relaxed max-w-md ml-auto"
            style={{ fontFamily: "'Oswald', sans-serif" }}
          >
