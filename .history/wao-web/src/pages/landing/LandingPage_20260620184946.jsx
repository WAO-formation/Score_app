        ...
        <div className="relative flex h-full w-full items-center px-6 sm:px-8 lg:px-10">
          <div className="mx-auto flex w-full max-w-7xl justify-end">
            <div className="max-w-2xl lg:pr-6 xl:pr-10">
              <h1
                className="text-right text-2xl font-black uppercase leading-[0.88] tracking-tight text-white sm:text-6xl lg:text-[4.7rem]"
                style={{ fontFamily: 'Georgia, Cambria, "Times New Roman", serif' }}
              >
                <span className="block">A New Era of Competition</span>
                <span className="mt-2 block">Without Boundaries</span>
              </h1>
